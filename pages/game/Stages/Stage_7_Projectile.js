...
export const Stage_7_Projectile = (props) => {
  // [USE CONTEXT API] - - - - - 
  ...
  const upgradeToSpecial_0_Position = useRef(new Animated.ValueXY({ x: WidthRatio(400), y: 0 })).current;
      ...
      <>
        {displayPlaybutton &&
          <>
            ...
            >
              <Image
                source={require('../../../assets/stage_transition_7.png')}
